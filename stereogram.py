...
for i in range(side_len):
  ...
  noise[side_len + i - 1, side_len + side_len] = 0 #np.random.normal(loc=0, scale=1, size=(1))
  noise[side_len + i - 2, side_len + side_len] = 0 #np.random.normal(loc=0, scale=1, size=(1))
  noise[side_len + i - 3, side_len + side_len] = 0 #np.random.normal(loc=0, scale=1, size=(1))
